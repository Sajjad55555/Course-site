  ...
  return (
    <div className="w-full h-auto">
      ...
      <div className="w-full h-auto flex justify-center mt-24 mb-48">
        ...
        <div className="h-auto w-full max-w-[1070px] flex flex-wrap justify-center flex-col md:flex-row items-center md:items-start  gap-4">
          
          {/* Text Content */}
          <div className="w-[760px] flex flex-col justify-center item-center bg-red-50 h-auto">
            {/* Section 1 */}
            <div className="flex gap-16 flex-col md:flex-row items-center justify-center md:items-start text-center md:text-start">
              {/* Title */}
          ...
          {/* Sidebar Section */}
          <div className="w-[285px] h-[686px] border-[3px] rounded-xl border-black">
            <About_farm />
          </div>
        </div>
      </div>
